...
## Nusantara Project
## https://github.com/NusantaraProject-ROM/android_manifest -b 11
export ROMNAME=nad
export ROMGIT="https://github.com/NusantaraProject-ROM/android_manifest -b 11"
...
sed -i "s|vendor/lineage/config|vendor/nusantara/config|" device/motorola/ginna/lineage_ginna.mk
