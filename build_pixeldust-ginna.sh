...
## https://github.com/pixeldust-project-caf/manifest -b rioja
export ROMNAME=pixeldust
export ROMGIT="https://github.com/pixeldust-project-caf/manifest -b rioja"
...
sed -i "s|vendor/lineage/config|vendor/$ROMNAME/configs|" device/motorola/ginna/lineage_ginna.mk
sed -i "s|common_full_phone.mk|$ROMNAME\_phone.mk|" device/motorola/ginna/lineage_ginna.mk
...
git clone https://github.com/ArrowOS/android_device_qcom_sepolicy-legacy-um -b arrow-11.0 device/qcom/sepolicy-legacy-um
...
time make $ROMNAME -j$(nproc --ignore=6)
echo ""
