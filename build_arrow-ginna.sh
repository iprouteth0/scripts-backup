...
## Arrow OS
## https://github.com/ArrowOS/android_manifest.git -b arrow-11.0
export ROMNAME=arrow
export ROMGIT="https://github.com/ArrowOS/android_manifest.git -b arrow-11.0"
...
#eval $($BUILDCOMMAND | tee /dev/tty)
lunch $ROMNAME\_ginna-eng
make bacon -j$(nproc --ignore=6) | tee /dev/tty
echo ""
echo " Rom Should Be Built"
echo ""
echo " ENTER TO CONTINUE"
