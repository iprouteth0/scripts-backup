...
## git://github.com/AOSiP/platform_manifest.git -b eleven
...
if [[ $gapps != 1 ]]
then 
git clone https://github.com/ArrowOS/android_packages_apps_Camera2 packages/apps/Camera2
else
echo "Camera app included in gapps build"
fi
sleep 2
echo ""
echo ""
