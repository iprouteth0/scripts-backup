...
## https://github.com/AICP/platform_manifest.git -b r11.1
export ROMNAME=aicp
export ROMGIT="https://github.com/AICP/platform_manifest.git -b r11.1"
...
#eval $($BUILDCOMMAND | tee /dev/tty)
lunch $ROMNAME\_ginna-eng
make bacon -j$(nproc --all) | tee /dev/tty
echo ""
echo " Rom Should Be Built"
echo ""
echo " ENTER TO CONTINUE"
