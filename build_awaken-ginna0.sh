...
## Awaken OS
## https://github.com/Project-Awaken/android_manifest -b 11
export ROMNAME=awaken
export ROMGIT="https://github.com/Project-Awaken/android_manifest -b 11"
export SOURCEFILE=Android.bp
#export BUILDCOMMAND="brunch ${ROMNAME}_ginna-eng"
#export BUILDCOMMAND="export ROMNAME=awaken && lunch $(ROMNAME)_ginna-eng && make $(ROMNAME) -j$(nproc --all)"
