...
## crDroid
## git://github.com/crdroidandroid/android.git -b 11.0
export ROMNAME=ginna
export ROMGIT="git://github.com/crdroidandroid/android.git -b 11.0"
