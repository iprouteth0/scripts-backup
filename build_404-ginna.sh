...
## Project 404
## https://github.com/P-404/platform_manifest -b rippa
export ROMNAME=p404
export ROMGIT="https://github.com/P-404/platform_manifest -b rippa"
...
git clone https://github.com/GZOSP/hardware_qcom_bootctrl hardware/qcom/bootctrl
