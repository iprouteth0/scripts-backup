...
## StormBreakerOS
## https://github.com/StormBreakerOSS/android_manifest
export ROMNAME=stormbreaker
export ROMGIT="https://github.com/StormBreakerOSS/android_manifest"
...
sed -i "s|common_full_phone.mk|common_telephony.mk|" device/motorola/ginna/lineage_ginna.mk
...
make storm-prod -j$(nproc --ignore=6)
echo ""
