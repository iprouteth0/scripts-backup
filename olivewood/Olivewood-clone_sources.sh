...
## Device Tree
#git clone https://github.com/Aghora7/device_xiaomi_olivewood-1 device/xiaomi/olivewood
git clone https://github.com/Xiaomi-SDM439-Development/android_device_xiaomi_sdm439 device/xiaomi/sdm439-common

## Vendor Tree
git clone https://github.com/Aghora7/vendor_xiaomi_olivewood_64 vendor/xiaomi/olivewood
git clone https://github.com/Redmi-7A-Development/android_vendor_xiaomi_sdm439-common vendor/xiaomi/sdm439-common
