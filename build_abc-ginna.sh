...
## ABC ROM
# https://github.com/ezio84/abc_manifest.git -b r
export ROMNAME=abc
export ROMGIT="https://github.com/ezio84/abc_manifest.git -b r"
...
sed -i "s|vendor/lineage/config|vendor/nexus/config|" device/motorola/ginna/lineage_ginna.mk
...
cp device/motorola/ginna/lineage_ginna.mk device/motorola/ginna/$ROMNAME\.mk
...
time make bacon -j$(nproc --ignore=4)
echo ""
...
#eval $($BUILDCOMMAND | tee /dev/tty)
lunch $ROMNAME\_ginna-eng
time make bacon -j$(nproc --ignore=6)
echo ""
echo " Rom Should Be Built"
echo ""
echo " ENTER TO CONTINUE"
