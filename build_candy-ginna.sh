...
## Candy Rom
## git://github.com/CandyRoms/candy.git -b c11
export ROMNAME=candy
export ROMGIT="git://github.com/CandyRoms/candy.git -b c11"
...
git clone https://github.com/Project-Awaken/android_hardware_qcom-caf_common.git -b 11 hardware/qcom-caf/msm8996
rm -rf hardware/qcom-caf-msm8996/fwk-detect
rm hardware/qcom-caf/msm8996/os_pickup_*
mv hardware/qcom-caf/msm8996/os_pickup.mk hardware/qcom-caf/msm8996/Android.mk
mv hardware/qcom-caf/msm8996/os_pickup.bp hardware/qcom-caf/msm8996/Android.bp
git clone https://github.com/Project-Awaken/android_hardware_qcom_display -b 11-caf-8996 hardware/qcom-caf/msm8996/display
git clone https://github.com/Project-Awaken/android_hardware_qcom_audio -b 11-caf-8996 hardware/qcom-caf/msm8996/audio
git clone https://github.com/Project-Awaken/android_hardware_qcom_media -b 11-caf-8996 hardware/qcom-caf/msm8996/media
sleep 2
echo ""
echo ""
echo ""
