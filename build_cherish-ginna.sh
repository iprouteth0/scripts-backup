...
## CherishOS
## https://github.com/CherishOS/android_manifest.git -b eleven
export ROMNAME=cherish
export ROMGIT="https://github.com/CherishOS/android_manifest.git -b eleven"
...
time make baon -j$(nproc --ignore=6)
echo ""
